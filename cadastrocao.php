...
<html lang="pt-br" dir="ltr">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <h2 class="jumbotron bg-info">Formulário Cão</h2>
       ...
       <form name="cad" method="post" action="cadastrocao.php">
        <div class="form-group">
         <input type="text" name="nomeCao" placeholder="Digite o nome do cão" autofocus class="form-control">
        </div>
        <div class="form-group">
         <input type="text" name="racaCao" placeholder="Digite a raça do cão" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         <input type="text" name="corCao" placeholder="Digite a cor do cão" class="form-control">
        </div>
        <div class="form-group">
         <input type="number" name="idadeCao" placeholder="Digite a idade do cão" class="form-control">
        </div>
        <div class="form-group">
         <input type="number" name="pesoCao" placeholder="Digite o peso do cão" class="form-control">
        </div>
        <div class="form-group">
    ...
    if(isset($_POST['cadastrar'])) {
      ...
      $erros = [];
      if(!Validacao::validarNome($_POST['nomeCao']))
      {
      ...
      if(count($erros) != 0)
      {
        ...
        header("location:cadastrocao.php");
        die();
      }

      $erros = [];
      if(!Validacao::validarRacaCor($_POST['racaCao']))
      {
      ...
      $erros = [];
      if(!Validacao::validarRacaCor($_POST['corCao']))
      {
      ...
      $erros = [];
      if(!Validacao::validarIdade($_POST['idadeCao']))
      {
      ...
      $erros = [];
      if(!Validacao::validarPeso($_POST['pesoCao']))
      {
